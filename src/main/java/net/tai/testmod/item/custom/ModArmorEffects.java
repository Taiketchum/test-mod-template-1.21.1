...
import net.tai.testmod.item.ModArmorMaterials;
...
public class ModArmorEffects extends ArmorItem {
            ...
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.RUBY_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.HASTE, 400, 2, false, false),
                                    new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 1, false, false)))
                    .put(ModArmorMaterials.KAIJU_ARMOR_MATERIAL,
    ...
    public ModArmorEffects(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
